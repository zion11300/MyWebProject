...
public class keywordSearch {
	...
	public List<APIData> starts(String keyword) throws Exception {
		System.out.println(keyword);

		URL url = new URL(
	            "http://api.visitkorea.or.kr/openapi/service/rest/KorService/searchKeyword?ServiceKey=r3ynkH4eMvOrrkti0tzwlafQJ4GYJ9vB37XPuVFwdbcv0VDHdBM5uqQ1V%2BoyAEr1lUScEImr8XalSjk5zMn0aw%3D%3D"+
	            "&keyword="+keyword+"&contentTypeId=15&cat1=A02&cat2=A0208&arrange=C&listYN=Y&pageNo=1&numOfRows=10&MobileOS=ETC&MobileApp=AppTesting");
